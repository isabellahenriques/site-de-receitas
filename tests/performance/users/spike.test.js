...
// Objetivo: Simular pico repentino de 500 usuários por 30 segundos
// Verificar: Comportamento da API sob carga extrema
...
export const options = {
  // Cenário: Simular pico repentino de 500 usuários por 30 segundos
  stages: [
